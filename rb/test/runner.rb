...
module PoetrydbTestRunner
  ...
  def self.env_override(m)
    live = getenv("POETRYDB_TEST_LIVE")
    override = getenv("POETRYDB_TEST_OVERRIDE")
    ...
    explain = getenv("POETRYDB_TEST_EXPLAIN")
    m["POETRYDB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = PoetrydbTestRunner
Helpers = PoetrydbHelpers
Vs = VoxgigStruct
