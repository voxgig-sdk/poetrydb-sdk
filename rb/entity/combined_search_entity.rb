...
class CombinedSearchEntity
  ...
  def make
    opts = @_entopts.dup
    CombinedSearchEntity.new(@_client, opts)
  end
  ...
  # @return [CombinedSearch, Hash] the current CombinedSearch data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CombinedSearch fields)
  def match_get
  ...
  #
  # @param reqmatch [CombinedSearchListMatch, Hash, nil] match filter (any subset of
  #   CombinedSearch fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CombinedSearch>, Array] the matching CombinedSearch items; raises PoetrydbError on failure
