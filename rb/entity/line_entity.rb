...
class LineEntity
  ...
  #   as an empty match, so client.Line.load works with no args).
  ...
  #
  # @param reqmatch [LineListMatch, Hash, nil] match filter (any subset of
  #   Line fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
