...
class TitleabEntity
  ...
  def make
    opts = @_entopts.dup
    TitleabEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [TitleabListMatch, Hash, nil] match filter (any subset of
  #   Titleab fields); defaults to nil, treated as an empty match that lists all.
