...
class AuthorabEntity
  ...
  def make
    opts = @_entopts.dup
    AuthorabEntity.new(@_client, opts)
  end
  ...
  # @return [Authorab, Hash] the current Authorab data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Authorab fields)
  def match_get
  ...
  #
  # @param reqmatch [AuthorabListMatch, Hash, nil] match filter (any subset of
  #   Authorab fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Authorab>, Array] the matching Authorab items; raises PoetrydbError on failure
