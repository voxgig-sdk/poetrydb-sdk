...
func registerSDKWords(r *eng.Registry, client *sdk.PoetrydbSDK) {
...
func runOp(client *sdk.PoetrydbSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
