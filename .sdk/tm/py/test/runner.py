...
class PoetrydbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PoetrydbTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PoetrydbTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PoetrydbTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
