...
class PoetrydbTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PoetrydbTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PoetrydbTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PoetrydbTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
...
def entity_data(v):
    return PoetrydbTestRunner.entity_data(v)
...
def live_client_options():
    return PoetrydbTestRunner.live_client_options()
