...
from projectname_sdk import PoetrydbSDK
from projectname_sdk.core.spec import PoetrydbSpec
from projectname_sdk.core.result import PoetrydbResult
from projectname_sdk.core.response import PoetrydbResponse
from projectname_sdk.core.operation import PoetrydbOperation
from projectname_sdk.core.error import PoetrydbError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import PoetrydbBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = PoetrydbSDK.test(None, None)
        ...
        class TestInitFeature(PoetrydbBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PoetrydbBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PoetrydbSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PoetrydbSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PoetrydbSDK.test(None, setup_opts)
