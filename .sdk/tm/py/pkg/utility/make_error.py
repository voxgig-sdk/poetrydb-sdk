...
def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import PoetrydbContext
        ctx = PoetrydbContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, PoetrydbError):
        errmsg = err.msg
