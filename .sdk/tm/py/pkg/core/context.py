...
from projectname_sdk.core.control import PoetrydbControl
...
class PoetrydbContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, PoetrydbResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PoetrydbResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PoetrydbError(code, msg, self)
