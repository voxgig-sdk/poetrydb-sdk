...
// Poetrydb SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class PoetrydbMakeRequest
{
    public static function call(PoetrydbContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new PoetrydbResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new PoetrydbResponse($fetched);
        } else {
