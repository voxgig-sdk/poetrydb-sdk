...
class PoetrydbGraphql
{
    ...
    // equivalent.
    public static function body(PoetrydbContext $ctx): mixed
    {
    ...
    public static function errors(PoetrydbContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
