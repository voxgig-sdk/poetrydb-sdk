...
{
    private static function utility(): PoetrydbUtility
    {
        return new PoetrydbUtility();
    }
    ...
    private static function ctx(array $over = []): PoetrydbContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PoetrydbContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PoetrydbOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PoetrydbError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PoetrydbOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PoetrydbMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PoetrydbOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PoetrydbMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PoetrydbOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PoetrydbMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PoetrydbSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PoetrydbMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PoetrydbResponse([]),
            'result' => new PoetrydbResult([]),
        ]);
        [, $err] = PoetrydbMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PoetrydbSpec([]),
            'response' => null,
            'result' => new PoetrydbResult([]),
        ]);
        [, $err] = PoetrydbMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PoetrydbSpec(['step' => 's']),
            'response' => new PoetrydbResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PoetrydbResult([]),
        ]);
        [, $err] = PoetrydbMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PoetrydbSpec(['step' => 's']),
            'response' => new PoetrydbResponse(self::resp(200, ['v' => 1])),
            'result' => new PoetrydbResult([]),
        ]);
        [, $err] = PoetrydbMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PoetrydbSpec(['step' => 's']),
            'response' => new PoetrydbResponse(self::resp(200, ['v' => 2])),
            'result' => new PoetrydbResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PoetrydbMakeResponse::call($ctx);
    ...
    {
        $preset = new PoetrydbResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PoetrydbSpec([]),
            'response' => new PoetrydbResponse([]),
            'result' => new PoetrydbResult([]),
        ...
        [$got, $err] = PoetrydbMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PoetrydbResult([])]);
        [, $err] = PoetrydbMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PoetrydbSpec([]), 'result' => null]);
        [, $err] = PoetrydbMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PoetrydbSpec(['step' => 's']),
            'result' => new PoetrydbResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PoetrydbOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PoetrydbMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PoetrydbSpec(['step' => 's']),
            'result' => new PoetrydbResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PoetrydbOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PoetrydbMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PoetrydbResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PoetrydbSpec([]),
            'result' => new PoetrydbResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PoetrydbMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PoetrydbMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PoetrydbError('boom', 'boom');
        $utility->fetcher = function (PoetrydbContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PoetrydbSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PoetrydbMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PoetrydbContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PoetrydbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PoetrydbResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PoetrydbContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PoetrydbSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PoetrydbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PoetrydbResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PoetrydbSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PoetrydbMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PoetrydbMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PoetrydbMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PoetrydbResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PoetrydbDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PoetrydbResult(['ok' => false])]);
        $this->expectException(PoetrydbError::class);
        PoetrydbDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PoetrydbResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PoetrydbMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PoetrydbMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PoetrydbBaseFeature();
        $b = new PoetrydbBaseFeature();
        PoetrydbFeatureAdd::call($ctx, $a);
        PoetrydbFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PoetrydbBaseFeature
    {
        $f = new PoetrydbBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PoetrydbFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PoetrydbContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PoetrydbSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PoetrydbPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PoetrydbResponse(['headers' => null]),
            'result' => new PoetrydbResult([]),
        ]);
        PoetrydbResultHeaders::call($ctx);
