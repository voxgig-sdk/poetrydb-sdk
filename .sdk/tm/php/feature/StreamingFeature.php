...
// Poetrydb SDK streaming feature
...
class PoetrydbStreamingFeature extends PoetrydbBaseFeature
{
    ...
    private function _iterate(PoetrydbResult $result): \Generator
    {
    ...
    private function _streamable(PoetrydbContext $ctx): bool
    {
