...
// Poetrydb SDK clienttrack feature
...
class PoetrydbClienttrackFeature extends PoetrydbBaseFeature
{
    ...
    public function PostConstruct(PoetrydbContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Poetrydb-SDK';
