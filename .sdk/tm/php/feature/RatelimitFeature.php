...
// Poetrydb SDK ratelimit feature
...
class PoetrydbRatelimitFeature extends PoetrydbBaseFeature
{
    ...
    private function _acquire(PoetrydbContext $ctx): void
    {
    ...
    private function _track(PoetrydbContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
