...
// Poetrydb SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PoetrydbTestFeature extends PoetrydbBaseFeature
{
    ...
    public function init(PoetrydbContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PoetrydbContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PoetrydbContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PoetrydbContext $ctx, $op, $args): array
    {
