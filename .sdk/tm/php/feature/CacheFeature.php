...
class PoetrydbCacheFeature extends PoetrydbBaseFeature
{
    ...
    private function _through(PoetrydbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
