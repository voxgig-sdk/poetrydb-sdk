...
|---|---|---|
| `ts/` | @voxgig-sdk/poetrydb-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/poetrydb-sdk \
      --repository voxgig-sdk/poetrydb-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/poetrydb-sdk` shows it, and
`npm trust revoke @voxgig-sdk/poetrydb-sdk --id=<id>` removes it.
