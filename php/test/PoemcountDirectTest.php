...
class PoemcountDirectTest extends TestCase
{
    public function test_direct_load_poemcount(): void
    {
        $setup = poemcount_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-poemcount", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
