...
class PoemcountEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        $poemcount_ref01_data_dt0_load_result = Helpers::to_map(is_object($poemcount_ref01_data_dt0_loaded) && method_exists($poemcount_ref01_data_dt0_loaded, 'data_get') ? $poemcount_ref01_data_dt0_loaded->data_get() : $poemcount_ref01_data_dt0_loaded);
        $this->assertNotNull($poemcount_ref01_data_dt0_load_result);
        $this->assertEquals($poemcount_ref01_data_dt0_load_result["id"], $poemcount_ref01_data["id"]);
