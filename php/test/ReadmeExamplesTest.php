...
// Poetrydb SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PoetrydbSDK::test)
...
{
    private const SDK_CLASS = 'PoetrydbSDK';
    ...
    private const SDK_BASE = 'poetrydb_sdk';
