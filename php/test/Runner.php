...
class PoetrydbTestRunner
{
    ...
    {
        $live = self::getenv('POETRYDB_TEST_LIVE');
        $override = self::getenv('POETRYDB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('POETRYDB_TEST_EXPLAIN');
...
class_alias('PoetrydbTestRunner', 'Runner');
class_alias('PoetrydbHelpers', 'Helpers');
