...
// Poetrydb SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PoetrydbOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PoetrydbOmni::structfix($now, Struct::undef()))
                        !== json_encode(PoetrydbOmni::structfix($val, Struct::undef()))) {
