...
class AuthorEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Author(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Author(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set POETRYDB_TEST_AUTHOR_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function author_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["author01", "author02", "author03"] as $k) {
    ...
    $entid_env_raw = getenv("POETRYDB_TEST_AUTHOR_ENTID");
