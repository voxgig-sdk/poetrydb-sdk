...
class TitleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TitleEntity($this->_client, $opts);
    }

    /**
     * @param Title|array $args Title data (assoc-array) to store.
     */
    ...
    /**
     * @return Title|array The current Title data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Title fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Title fields).
     */
     ...
     * Load a single Title.
     *
     * @param TitleLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TitleLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Title|array The loaded Title as an assoc-array at the
    ...
    /**
     * List Title items matching the given filter.
     *
     * @param TitleListMatch|array|null $reqmatch Match filter (any subset
     *   of Title fields) as an assoc-array; TitleListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Title[]|array A list of Title items as assoc-arrays at
