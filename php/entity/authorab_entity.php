...
class AuthorabEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AuthorabEntity($this->_client, $opts);
    }

    /**
     * @param Authorab|array $args Authorab data (assoc-array) to store.
     */
    ...
    /**
     * @return Authorab|array The current Authorab data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Authorab fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Authorab fields).
     */
    ...
    /**
     * List Authorab items matching the given filter.
     *
     * @param AuthorabListMatch|array|null $reqmatch Match filter (any subset
     *   of Authorab fields) as an assoc-array; AuthorabListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Authorab[]|array A list of Authorab items as assoc-arrays at
