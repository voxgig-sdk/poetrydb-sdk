...
class AuthorEntity
{
     ...
     *
     * @param AuthorListMatch|array|null $reqmatch Match filter (any subset
     *   of Author fields) as an assoc-array; AuthorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Author[]|array A list of Author items as assoc-arrays at
