...
// Poetrydb SDK CombinedSearch entity
...
class CombinedSearchEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CombinedSearchEntity($this->_client, $opts);
    }

    /**
     * @param CombinedSearch|array $args CombinedSearch data (assoc-array) to store.
     */
    ...
    /**
     * @return CombinedSearch|array The current CombinedSearch data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CombinedSearch fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CombinedSearch fields).
     */
    ...
    /**
     * List CombinedSearch items matching the given filter.
     *
     * @param CombinedSearchListMatch|array|null $reqmatch Match filter (any subset
     *   of CombinedSearch fields) as an assoc-array; CombinedSearchListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CombinedSearch[]|array A list of CombinedSearch items as assoc-arrays at
