...
class LineEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LineEntity($this->_client, $opts);
    }

    /**
     * @param Line|array $args Line data (assoc-array) to store.
     */
    ...
    /**
     * @return Line|array The current Line data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Line fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Line fields).
     */
     ...
     * Load a single Line.
     *
     * @param LineLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LineLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Line|array The loaded Line as an assoc-array at the
     ...
     *
     * @param LineListMatch|array|null $reqmatch Match filter (any subset
     *   of Line fields) as an assoc-array; LineListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Line[]|array A list of Line items as assoc-arrays at
