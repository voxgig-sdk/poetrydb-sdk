...
class PoetrydbFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PoetrydbSDK/1.0)';
    ...
    public static function call(PoetrydbContext $ctx, string $fullurl, array $fetchdef): array
    {
