...
class PoetrydbTimeoutFeature extends PoetrydbBaseFeature
{
    ...
    private function _with_timeout(PoetrydbContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PoetrydbContext $_ctx, float $ms): void
    {
        $client = $this->client;
