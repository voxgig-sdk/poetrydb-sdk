...
class PoetrydbRbacFeature extends PoetrydbBaseFeature
{
    ...
    private function _required(PoetrydbContext $ctx): ?string
    {
    ...
    private function _reject(PoetrydbContext $ctx, string $required): void
    {
    ...
    private function _track(PoetrydbContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
