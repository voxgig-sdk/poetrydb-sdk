...
class PoetrydbProxyFeature extends PoetrydbBaseFeature
{
    ...
    public function init(PoetrydbContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PoetrydbContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
