...
The PHP SDK for the Poetrydb API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Author(null)->list(null, null);
...
[$result, $err] = $client->Poetrydb(null)->load(
    ["id" => "test01"], null
);
