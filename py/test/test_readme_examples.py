# Poetrydb SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PoetrydbSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PoetrydbSDK(...) and PoetrydbSDK.test(...) become
#      PoetrydbSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "poetrydb_sdk"
_SDK_CLASS = "PoetrydbSDK"
...
_ENTITIES = {
    ...
    "CombinedSearchWithField": "combined_search_with_field",
    "Line": "line",
    "Linecount": "linecount",
    "Poemcount": "poemcount",
    "Random": "random",
