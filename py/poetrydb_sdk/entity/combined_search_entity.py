...
class CombinedSearchEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CombinedSearchEntity(self._client, opts)
    ...
    def data_get(self) -> CombinedSearch:
    ...
    def match_get(self) -> CombinedSearch:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CombinedSearch]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CombinedSearch().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
