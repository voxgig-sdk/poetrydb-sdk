...
from poetrydb_sdk.poetrydb_types import (
    CombinedSearchWithField,
    CombinedSearchWithFieldListMatch,
)


class CombinedSearchWithFieldEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CombinedSearchWithFieldEntity(self._client, opts)
    ...
    def data_get(self) -> CombinedSearchWithField:
    ...
    def match_get(self) -> CombinedSearchWithField:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CombinedSearchWithField]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CombinedSearchWithField().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
