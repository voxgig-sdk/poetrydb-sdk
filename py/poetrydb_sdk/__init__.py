...
from poetrydb_sdk.utility import register

# Load features
from poetrydb_sdk.feature.base_feature import PoetrydbBaseFeature
from poetrydb_sdk.features import _has_feature, _make_feature
...
class PoetrydbSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "PoetrydbSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PoetrydbSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Author(self, data=None) -> "AuthorEntity":
        ...
        from poetrydb_sdk.entity.author_entity import AuthorEntity
    ...
    def Authorab(self, data=None) -> "AuthorabEntity":
        ...
        from poetrydb_sdk.entity.authorab_entity import AuthorabEntity
    ...
    def CombinedSearch(self, data=None) -> "CombinedSearchEntity":
        ...
        from poetrydb_sdk.entity.combined_search_entity import CombinedSearchEntity
    ...
    def CombinedSearchWithField(self, data=None) -> "CombinedSearchWithFieldEntity":
        ...
        from poetrydb_sdk.entity.combined_search_with_field_entity import CombinedSearchWithFieldEntity
    ...
    def Line(self, data=None) -> "LineEntity":
        ...
        from poetrydb_sdk.entity.line_entity import LineEntity
    ...
    def Linecount(self, data=None) -> "LinecountEntity":
        ...
        from poetrydb_sdk.entity.linecount_entity import LinecountEntity
    ...
    def Poemcount(self, data=None) -> "PoemcountEntity":
        ...
        from poetrydb_sdk.entity.poemcount_entity import PoemcountEntity
    ...
    def Titleab(self, data=None) -> "TitleabEntity":
        ...
        from poetrydb_sdk.entity.titleab_entity import TitleabEntity
