-- Poetrydb SDK Poemcount entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local PoemcountEntity = {}
PoemcountEntity.__index = PoemcountEntity


function PoemcountEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PoemcountEntity)
  self._name = "poemcount"
  self._client = client
...
function PoemcountEntity:get_name()
  return self._name
end


function PoemcountEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PoemcountEntity.new(self._client, opts)
end
...
function PoemcountEntity:mark_deleted()
  self._deleted = true
end


function PoemcountEntity:deleted()
  return true == self._deleted
end


function PoemcountEntity:data_set(args)
  if args ~= nil then
...
function PoemcountEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PoemcountEntity:match_set(args)
  if args ~= nil then
...
function PoemcountEntity:match_get()
...
function PoemcountEntity:stream(action, args, callopts)
...
function PoemcountEntity:_run_op(ctx, post_done)
  local utility = self._utility
