...
local TitleEntity = {}
TitleEntity.__index = TitleEntity


function TitleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TitleEntity)
  self._name = "title"
  self._client = client
...
function TitleEntity:get_name()
  return self._name
end


function TitleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TitleEntity.new(self._client, opts)
end
...
function TitleEntity:mark_deleted()
  self._deleted = true
end


function TitleEntity:deleted()
  return true == self._deleted
end


function TitleEntity:data_set(args)
  if args ~= nil then
...
function TitleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TitleEntity:match_set(args)
  if args ~= nil then
...
function TitleEntity:match_get()
...
function TitleEntity:stream(action, args, callopts)
...
---@param reqmatch TitleLoadMatch
---@param ctrl? table
---@return Title
---@return string? err
function TitleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TitleListMatch
---@param ctrl? table
---@return Title[]
---@return string? err
function TitleEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function TitleEntity:_run_op(ctx, post_done)
  local utility = self._utility
