...
describe("PoemcountDirect", function()
  it("should direct-load-poemcount", function()
    local setup = poemcount_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-poemcount", setup.live and "live" or "unit")
...
function poemcount_direct_setup(mockres)
