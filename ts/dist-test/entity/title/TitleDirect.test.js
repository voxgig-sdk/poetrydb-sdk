...
(0, node_test_1.describe)('TitleDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-title', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-title', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-title', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-title', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["format01", "output_field01", "title01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_TITLE_ENTID'];
...
//# sourceMappingURL=TitleDirect.test.js.map