...
(0, node_test_1.describe)('AuthorabDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-authorab', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-authorab', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["author01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_AUTHORAB_ENTID'];
...
//# sourceMappingURL=AuthorabDirect.test.js.map