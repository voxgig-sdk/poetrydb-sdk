...
(0, node_test_1.describe)('LineDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-line', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-line', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-line', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-line', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["format01", "line01", "output_field01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_LINE_ENTID'];
...
//# sourceMappingURL=LineDirect.test.js.map