...
(0, node_test_1.describe)('TitleabDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-titleab', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-titleab', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["title01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_TITLEAB_ENTID'];
...
//# sourceMappingURL=TitleabDirect.test.js.map