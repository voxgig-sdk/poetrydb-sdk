...
(0, node_test_1.describe)('CombinedSearchDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-combined_search', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-combined_search', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["input_field101", "input_field201", "search_term101", "search_term201"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_COMBINED_SEARCH_ENTID'];
...
//# sourceMappingURL=CombinedSearchDirect.test.js.map