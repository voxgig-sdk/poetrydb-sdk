...
(0, node_test_1.describe)('LinecountDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-linecount', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-linecount', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-linecount', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-linecount', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["format01", "linecount01", "output_field01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_LINECOUNT_ENTID'];
...
//# sourceMappingURL=LinecountDirect.test.js.map