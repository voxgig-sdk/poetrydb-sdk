...
(0, node_test_1.describe)('LinecountEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        let linecount_ref01_data = Object.values(setup.data.existing.linecount)[0];
        // LIST
        const linecount_ref01_ent = client.Linecount();
        const linecount_ref01_match = {};
        linecount_ref01_match['linecount'] = setup.idmap['linecount01'];
        linecount_ref01_match['output_field'] = setup.idmap['output_field01'];
        const linecount_ref01_list = (await linecount_ref01_ent.list(linecount_ref01_match)).map((e) => e.data());
        // LOAD
        const linecount_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(linecount_ref01_data_dt0.id === linecount_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/linecount/LinecountTestData.json');
    ...
    let idmap = transform(['linecount01', 'linecount02', 'linecount03', 'linecount01', 'linecount02', 'linecount03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=LinecountEntity.test.js.map