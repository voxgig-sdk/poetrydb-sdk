...
(0, node_test_1.describe)('PoemcountDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-poemcount', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-poemcount', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['POETRYDB_TEST_POEMCOUNT_ENTID'];
...
//# sourceMappingURL=PoemcountDirect.test.js.map