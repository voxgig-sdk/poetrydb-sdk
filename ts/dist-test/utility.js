...
function envOverride(m) {
    if ('TRUE' === process.env.POETRYDB_TEST_LIVE ||
        'TRUE' === process.env.POETRYDB_TEST_OVERRIDE) {
    ...
    m.POETRYDB_TEST_EXPLAIN = process.env.POETRYDB_TEST_EXPLAIN || m.POETRYDB_TEST_EXPLAIN;
    return m;
}
