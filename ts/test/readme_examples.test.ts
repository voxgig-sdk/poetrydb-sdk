...
//     (\`new PoetrydbSDK(...)\` / \`PoetrydbSDK.test(...)\` become
//     \`PoetrydbSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"author":{"test01":{"id":"test01"}},"authorab":{"test01":{"id":"test01"}},"combined_search":{"test01":{"id":"test01"}},"combined_search_with_field":{"test01":{"id":"test01"}},"line":{"test01":{"id":"test01"}},"linecount":{"test01":{"id":"test01"}},"poemcount":{"test01":{"id":"test01"}},"random":{"test01":{"id":"test01"}},"title":{"test01":{"id":"test01"}},"titleab":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new PoetrydbSDK(...)\` and any
// \`PoetrydbSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+PoetrydbSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/PoetrydbSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
