...
describe('TitleabDirect', async () => {
  ...
  test('direct-list-titleab', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-titleab', setup.live)) return
    if (skipIfMissingIds(t, setup, ["title01"])) return
