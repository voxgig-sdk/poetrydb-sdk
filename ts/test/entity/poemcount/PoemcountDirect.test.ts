...
describe('PoemcountDirect', async () => {
  ...
  test('direct-load-poemcount', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-poemcount', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['POETRYDB_TEST_POEMCOUNT_ENTID']
