...
func (sdk *PoetrydbSDK) OptionsMap() map[string]any {
...
func (sdk *PoetrydbSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *PoetrydbSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *PoetrydbSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PoetrydbSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *PoetrydbSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *PoetrydbSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("PoetrydbSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *PoetrydbSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *PoetrydbSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("PoetrydbSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
