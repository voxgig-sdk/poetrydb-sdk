...
The Golang SDK for the Poetrydb API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/poetrydb-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/poetrydb-sdk=../path/to/github.com/voxgig-sdk/poetrydb-sdk
```
...
```
github.com/voxgig-sdk/poetrydb-sdk/
...
The root package (`github.com/voxgig-sdk/poetrydb-sdk`) re-exports everything needed
