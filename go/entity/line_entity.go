...
func NewLineEntity(client *core.PoetrydbSDK, entopts map[string]any) *LineEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LineEntity) GetName() string { return e.name }
...
func (e *LineEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LineEntity) Deleted() bool {
	return e.deleted
}


func (e *LineEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLineEntity(e.client, opts)
}

func (e *LineEntity) Data(args ...any) any {
...
func (e *LineEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Line; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LineEntity) DataTyped(data ...Line) Line {
	if len(data) > 0 {
		return typedFrom[Line](e.Data(asMap(data[0])))
	}
	return typedFrom[Line](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Line (all fields
// optional at the wire level).
func (e *LineEntity) MatchTyped(match ...Line) Line {
	if len(match) > 0 {
		return typedFrom[Line](e.Match(asMap(match[0])))
	}
	return typedFrom[Line](e.Match())
}
...
func (e *LineEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LineEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LineLoadMatch and returns an Line. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LineEntity) LoadTyped(reqmatch LineLoadMatch, ctrl map[string]any) (Line, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Line{}, err
	}
	return typedFrom[Line](res), nil
}




func (e *LineEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LineListMatch and returns []Line. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LineEntity) ListTyped(reqmatch LineListMatch, ctrl map[string]any) ([]Line, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Line](res), nil
}



func (e *LineEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LineEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LineEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LineEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
