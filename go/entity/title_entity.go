...
func NewTitleEntity(client *core.PoetrydbSDK, entopts map[string]any) *TitleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TitleEntity) GetName() string { return e.name }
...
func (e *TitleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TitleEntity) Deleted() bool {
	return e.deleted
}


func (e *TitleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTitleEntity(e.client, opts)
}

func (e *TitleEntity) Data(args ...any) any {
...
func (e *TitleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Title; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TitleEntity) DataTyped(data ...Title) Title {
	if len(data) > 0 {
		return typedFrom[Title](e.Data(asMap(data[0])))
	}
	return typedFrom[Title](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Title (all fields
// optional at the wire level).
func (e *TitleEntity) MatchTyped(match ...Title) Title {
	if len(match) > 0 {
		return typedFrom[Title](e.Match(asMap(match[0])))
	}
	return typedFrom[Title](e.Match())
}
...
func (e *TitleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TitleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TitleLoadMatch and returns an Title. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TitleEntity) LoadTyped(reqmatch TitleLoadMatch, ctrl map[string]any) (Title, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Title{}, err
	}
	return typedFrom[Title](res), nil
}




func (e *TitleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TitleListMatch and returns []Title. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TitleEntity) ListTyped(reqmatch TitleListMatch, ctrl map[string]any) ([]Title, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Title](res), nil
}



func (e *TitleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TitleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TitleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TitleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
