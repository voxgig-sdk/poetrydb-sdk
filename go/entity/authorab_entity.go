...
func NewAuthorabEntity(client *core.PoetrydbSDK, entopts map[string]any) *AuthorabEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthorabEntity) GetName() string { return e.name }
...
func (e *AuthorabEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuthorabEntity) Deleted() bool {
	return e.deleted
}


func (e *AuthorabEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuthorabEntity(e.client, opts)
}

func (e *AuthorabEntity) Data(args ...any) any {
...
func (e *AuthorabEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Authorab; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AuthorabEntity) DataTyped(data ...Authorab) Authorab {
	if len(data) > 0 {
		return typedFrom[Authorab](e.Data(asMap(data[0])))
	}
	return typedFrom[Authorab](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Authorab (all fields
// optional at the wire level).
func (e *AuthorabEntity) MatchTyped(match ...Authorab) Authorab {
	if len(match) > 0 {
		return typedFrom[Authorab](e.Match(asMap(match[0])))
	}
	return typedFrom[Authorab](e.Match())
}
...
func (e *AuthorabEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuthorabEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AuthorabEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AuthorabListMatch and returns []Authorab. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AuthorabEntity) ListTyped(reqmatch AuthorabListMatch, ctrl map[string]any) ([]Authorab, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Authorab](res), nil
}



func (e *AuthorabEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuthorabEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuthorabEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuthorabEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
