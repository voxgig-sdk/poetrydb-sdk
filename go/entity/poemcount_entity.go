...
func NewPoemcountEntity(client *core.PoetrydbSDK, entopts map[string]any) *PoemcountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PoemcountEntity) GetName() string { return e.name }
...
func (e *PoemcountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PoemcountEntity) Deleted() bool {
	return e.deleted
}


func (e *PoemcountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPoemcountEntity(e.client, opts)
}

func (e *PoemcountEntity) Data(args ...any) any {
...
func (e *PoemcountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Poemcount; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PoemcountEntity) DataTyped(data ...Poemcount) Poemcount {
	if len(data) > 0 {
		return typedFrom[Poemcount](e.Data(asMap(data[0])))
	}
	return typedFrom[Poemcount](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Poemcount (all fields
// optional at the wire level).
func (e *PoemcountEntity) MatchTyped(match ...Poemcount) Poemcount {
	if len(match) > 0 {
		return typedFrom[Poemcount](e.Match(asMap(match[0])))
	}
	return typedFrom[Poemcount](e.Match())
}
...
func (e *PoemcountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PoemcountEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PoemcountLoadMatch and returns an Poemcount. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PoemcountEntity) LoadTyped(reqmatch PoemcountLoadMatch, ctrl map[string]any) (Poemcount, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Poemcount{}, err
	}
	return typedFrom[Poemcount](res), nil
}



func (e *PoemcountEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PoemcountEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PoemcountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PoemcountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PoemcountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
