...
func NewTitleabEntity(client *core.PoetrydbSDK, entopts map[string]any) *TitleabEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TitleabEntity) GetName() string { return e.name }
...
func (e *TitleabEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TitleabEntity) Deleted() bool {
	return e.deleted
}


func (e *TitleabEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTitleabEntity(e.client, opts)
}

func (e *TitleabEntity) Data(args ...any) any {
...
func (e *TitleabEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Titleab; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TitleabEntity) DataTyped(data ...Titleab) Titleab {
	if len(data) > 0 {
		return typedFrom[Titleab](e.Data(asMap(data[0])))
	}
	return typedFrom[Titleab](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Titleab (all fields
// optional at the wire level).
func (e *TitleabEntity) MatchTyped(match ...Titleab) Titleab {
	if len(match) > 0 {
		return typedFrom[Titleab](e.Match(asMap(match[0])))
	}
	return typedFrom[Titleab](e.Match())
}
...
func (e *TitleabEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TitleabEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TitleabEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TitleabListMatch and returns []Titleab. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TitleabEntity) ListTyped(reqmatch TitleabListMatch, ctrl map[string]any) ([]Titleab, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Titleab](res), nil
}



func (e *TitleabEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TitleabEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TitleabEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TitleabEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
