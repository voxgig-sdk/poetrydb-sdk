...
func NewLinecountEntity(client *core.PoetrydbSDK, entopts map[string]any) *LinecountEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LinecountEntity) GetName() string { return e.name }
...
func (e *LinecountEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LinecountEntity) Deleted() bool {
	return e.deleted
}


func (e *LinecountEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLinecountEntity(e.client, opts)
}

func (e *LinecountEntity) Data(args ...any) any {
...
func (e *LinecountEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Linecount; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LinecountEntity) DataTyped(data ...Linecount) Linecount {
	if len(data) > 0 {
		return typedFrom[Linecount](e.Data(asMap(data[0])))
	}
	return typedFrom[Linecount](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Linecount (all fields
// optional at the wire level).
func (e *LinecountEntity) MatchTyped(match ...Linecount) Linecount {
	if len(match) > 0 {
		return typedFrom[Linecount](e.Match(asMap(match[0])))
	}
	return typedFrom[Linecount](e.Match())
}
...
func (e *LinecountEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LinecountEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LinecountLoadMatch and returns an Linecount. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LinecountEntity) LoadTyped(reqmatch LinecountLoadMatch, ctrl map[string]any) (Linecount, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Linecount{}, err
	}
	return typedFrom[Linecount](res), nil
}




func (e *LinecountEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LinecountListMatch and returns []Linecount. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LinecountEntity) ListTyped(reqmatch LinecountListMatch, ctrl map[string]any) ([]Linecount, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Linecount](res), nil
}



func (e *LinecountEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LinecountEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LinecountEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LinecountEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
