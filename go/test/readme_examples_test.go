...
const testSeed = `map[string]any{"entity": map[string]any{"author": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authorab": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "combined_search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "combined_search_with_field": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "line": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "linecount": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "poemcount": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "title": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "titleab": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
